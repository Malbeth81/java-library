...
public class OrderableJTabbedPane extends JTabbedPane {
    private static final long serialVersionUID = -177301957794823710L;
    ...
    public OrderableJTabbedPane() {
        ...
        final Transferable t = new Transferable() {
            ...
            public Object getTransferData(DataFlavor flavor) {
                return OrderableJTabbedPane.this;
            }
    ...
    private int getTargetTabIndex(Point glassPt) {
        Point tabPt = SwingUtilities.convertPoint(glassPane, glassPt, OrderableJTabbedPane.this);
    ...
    class GhostGlassPane extends JPanel {
        private static final long serialVersionUID = -2908279086412486783L;
